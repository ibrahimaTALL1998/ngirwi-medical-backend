...
import sn.ngirwi.medical.service.PatientService;
...
/**
 * REST controller for managing {@link sn.ngirwi.medical.domain.Patient}.
 */
@RestController
@RequestMapping("/api")
public class PatientResource {
    ...
    public ResponseEntity<PatientDTO> partialUpdatePatient(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, patientDTO.getId().toString())
        );
    }
